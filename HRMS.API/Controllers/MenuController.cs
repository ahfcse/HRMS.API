...
namespace HRMS.API.Controllers
{
    ...
    public class MenuController : Controller
    {
        ...
        {
            var data = await _unitOfWork.Menus.GetAsync(id);
            return Ok(data);
        }
        [HttpPost("Create")]
        public async Task<IActionResult> Create(Menu entity)
        {
            var data = await _unitOfWork.Menus.AddEntity(entity);
        ...
        {
            var data = await _unitOfWork.Menus.UpdateEntity(entity);
            await _unitOfWork.CompletAsync();
            return Ok(data);
        }
        [HttpDelete("Delete")]
        ...
        {
            var data = await _unitOfWork.Menus.DeleteEntity(id);
            await _unitOfWork.CompletAsync();
            return Ok(data);
        }
